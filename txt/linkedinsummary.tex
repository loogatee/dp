...
\vspace{3mm}\noindent\parbox{.3in}{\hspace{.25in}}\parbox{6.0in}
{
It's for the Golf Guys in Greeley, CO.  I love them.  The website runs under Google App Engine, and is written in python.
}
...
\vspace{3mm}\noindent\parbox{.3in}{\hspace{.25in}}\parbox{6.0in}
{
A Throwback from the Internet Time Machine:
}

\hbox{\hspace{.5in}\parbox{6.1in}
{
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
    \item    {google on:}     comp.os.xinu google groups
    \item    {click on the top hit:}      ``comp.os.xinu - Google Groups''
    \item    {Search (include quotes):}   ``John Reed''
\end{itemize}
}}
